...
@Component({
  selector: 'app-angularintro',
  templateUrl: './angularintro.component.html',
  styleUrls: ['./angularintro.component.css'],
})
export class AngularintroComponent implements OnInit {
  ...
  private getEmployees() {
    this.employeeService.getEmployeesListByType('Angular').subscribe((data) => {
      this.employees = data;
